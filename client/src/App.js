      ...
      <Provider store={store}>
        <Router>
          <div className="App">
            ...
            <Route exact path="/:userId/dashboardVol" component={ParNavbar} />
            <Route exact path="/:userId/dashboardVol" component={DashBoardVol} />
            <Route exact path="/admin" component={AuthNavbar} />
            <Route exact path="/admin" component={Admin} />
            <Route exact path="/newprogram" component={NewProgram} />
            <Route
              exact
              path="/managevolunteers/:ram"
              component={ManageVolunteers}
            />
            <Route exact path="/:userId/programs/:ram" component={ParNavbar} />
